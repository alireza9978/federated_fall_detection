...
import wandb
from fl_fall.task import create_run_dir, load_model

from flwr.common import logger, parameters_to_ndarrays
from flwr.common.typing import UserConfig
from flwr.server.strategy import FedAvg

PROJECT_NAME = "FLOWER-fall"
...
class CustomFedAvg(FedAvg):
    ...
    def _update_best_loss(self, round, loss, parameters):
        ...
        if loss < self.best_loss_so_far:
            ...
            logger.log(INFO, "💡 New best global model found: %f", loss)
            ...
            file_name = (
                self.save_path
                / f"model_state_loss_{loss:.5f}_round_{round}.weights.h5"
            )
    ...
    def evaluate(self, server_round, parameters):
        ...
        self._update_best_loss(server_round, loss, parameters)

        # Store and log
        self.store_results_and_log(
            server_round=server_round,
            tag="centralized_evaluate",
            results_dict={"centralized_loss": loss},
        )
        return loss, metrics
    ...
    def aggregate_evaluate(self, server_round, results, failures):
        ...
        self.store_results_and_log(
            ...
            results_dict={"federated_evaluate_loss": loss},
        )
        return loss, metrics
